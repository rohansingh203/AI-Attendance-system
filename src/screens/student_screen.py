...
import numpy as np
from src.pipline.face_pipline import predict_attendance, get_face_embeddings, train_classifier
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Rohan Singh')
            ...
            audio_data = None
            try:
                audio_data = st.audio_input("Record a short phrase like I am present, My name is rohan")
            except Exception:
